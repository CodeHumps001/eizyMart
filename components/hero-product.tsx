...
export default function HeroProductDisplay() {
  ...
  return (
    <div className="relative h-[500px] md:h-[600px] w-full rounded-3xl overflow-hidden  shadow-xl">
        ...
        {newProducts.map((product) => (
          ...
          >
            ...
            <div className="relative z-10 p-6 md:p-20 text-white w-full">
              <div className="max-w-70 sm:max-w-md md:max-w-2xl space-y-4">
                <span className="text-orange-500 text-xs md:text-sm font-bold tracking-[0.3em] uppercase">
                  New Product
                </span>
                <h1 className="text-3xl md:text-7xl font-bold uppercase leading-[1.1] wrap-break-word">
                  {product.name}
                </h1>
