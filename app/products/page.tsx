...
// Reusing the modern product card component from previous turns
...
export default function ProductListingPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-16">
      ...
      {/* Categories Tabs - The Fix for Overflow */}
      <div className="flex gap-3 mb-10 overflow-x-auto whitespace-nowrap scroll-smooth pb-3">
      ...
      {/* Note: You might need to add a custom CSS utility if default Tailwind hides scrollbars completely on some mobile devices, but this structure should allow horizontal scrolling. */}
    </main>
  );
}
